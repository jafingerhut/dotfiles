...
# At least in the version of ls I use on MacOSX, BLOCKSIZE=1024
# changes the block size used by "ls -s" to be 1KB blocks instead of
# the default 512-byte blocks.
