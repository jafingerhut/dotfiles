...
then
    ...
    1>&2 echo "    sudo apt-get install 7zip (Ubuntu 24.04)"
    1>&2 echo "On Ubuntu Linux you can use this command to install '7za':"
    1>&2 echo "    sudo apt-get install p7zip-full (Ubuntu 20.04)"
...
echo ""
echo "----------------------------------------------------------------------"
echo "To extract the file on Ubuntu 20.04 Linux:"
echo "    sudo apt-get install p7zip-full"
echo "    7za e archive.7z"
echo "To extract the file on macOS with Homebrew:"
echo "    brew install sevenzip"
echo "    7zz e archive.7z"
echo "----------------------------------------------------------------------"
